...
void IceAgent::_on_ice_receiving_state(IceTransportChannel* channel) {
    _update_state();
}

void IceAgent::_on_ice_writable_state(IceTransportChannel* channel) {
    _update_state();
}

void IceAgent::_on_ice_state_changed(IceTransportChannel* channel) {
    _update_state();
}
