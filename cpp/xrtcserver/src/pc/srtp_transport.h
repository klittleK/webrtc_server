...
public:
    ...
    bool set_rtp_params(int send_cs, const 
        uint8_t* send_key, size_t send_key_len, 
        const std::vector<int>& send_extension_ids, int recv_cs, 
    ...
    void get_send_auth_tag_len(int* rtp_auth_tag_len, int* rtcp_auto_tag_len);
