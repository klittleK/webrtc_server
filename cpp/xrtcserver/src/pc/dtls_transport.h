...
public:
    ...
    bool export_keying_material(const std::string& label, const uint8_t* context, size_t context_len, bool use_context, uint8_t* result, size_t result_len);
...
private:
    ...
    rtc::Buffer _remote_fingerprint_value; // 远端证书的指纹
