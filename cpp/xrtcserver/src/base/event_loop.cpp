...
static void generic_io_cb(struct ev_loop*, struct ev_io* io, int events) {
...
static void generic_time_cb(struct ev_loop*, struct ev_timer* timer, int) {
